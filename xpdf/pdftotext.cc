...
static ArgDesc argDesc[] = {
	...
	{ "-simple2"      , argFlag  , &simple2Layout   , 0                    , "simple one-column page layout, version 2"           },
	...
	{ "-nopgbrk"      , argFlag  , &noPageBreaks    , 0                    , "don't insert a page break at the end of each page"  },
	...
	{ "-listencodings", argFlag  , &listEncodings   , 0                    , "list all available output text encodings"           },
