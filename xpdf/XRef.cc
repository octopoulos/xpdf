...
GBool XRef::constructXRefEntry(int num, int gen, GFileOffset pos, XRefEntryType type)
{
	if (num >= size)
	{
...
GBool XRef::getObjectStreamObject(int objStrNum, int objIdx, int objNum, Object* obj, int recursion)
{
