...
public:
	...
	static LinkAction* parseAction(Object* obj, GString* baseURI = nullptr);
...
public:
	...
	virtual GBool isOk() { return fileName != nullptr; }
...
public:
	...
	virtual GBool isOk() { return uri != nullptr; }
...
public:
	...
	virtual GBool isOk() { return name != nullptr; }
...
public:
	...
	virtual GBool isOk() { return annotRef.num >= 0 || title != nullptr; }
...
public:
	...
	virtual GBool isOk() { return js != nullptr; }
...
public:
	...
	virtual GBool isOk() { return url != nullptr; }
...
public:
	...
	virtual GBool isOk() { return action != nullptr; }
