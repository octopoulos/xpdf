...
public:
	...
	PSOutputDev(char* fileName, PDFDoc* docA, int firstPageA, int lastPageA, PSOutMode modeA, int imgLLXA = 0, int imgLLYA = 0, int imgURXA = 0, int imgURYA = 0, GBool manualCtrlA = gFalse, PSOutCustomCodeCbk customCodeCbkA = nullptr, void* customCodeCbkDataA = nullptr, GBool honorUserUnitA = gFalse, GBool fileNameIsUTF8 = gFalse);

	// Open a PSOutputDev that will write to a generic stream.
	PSOutputDev(PSOutputFunc outputFuncA, void* outputStreamA, PDFDoc* docA, int firstPageA, int lastPageA, PSOutMode modeA, int imgLLXA = 0, int imgLLYA = 0, int imgURXA = 0, int imgURYA = 0, GBool manualCtrlA = gFalse, PSOutCustomCodeCbk customCodeCbkA = nullptr, void* customCodeCbkDataA = nullptr, GBool honorUserUnitA = gFalse);
	...
	virtual GBool checkPageSlice(Page* page, double hDPI, double vDPI, int rotate, GBool useMediaBox, GBool crop, int sliceX, int sliceY, int sliceW, int sliceH, GBool printing, GBool (*abortCheckCbk)(void* data) = nullptr, void* abortCheckCbkData = nullptr);
	...
	//----- text drawing
	virtual void drawString(GfxState* state, GString* s, GBool fill, GBool stroke, GBool makePath);
...
private:
	void            init(PSOutputFunc outputFuncA, void* outputStreamA, PSFileType fileTypeA, PDFDoc* docA, int firstPageA, int lastPageA, PSOutMode modeA, int imgLLXA, int imgLLYA, int imgURXA, int imgURYA, GBool manualCtrlA, GBool honorUserUnitA);
	...
	PSFontFileInfo* setupExternalOpenTypeT1CFont(GfxFont* font, GString* fileName);
	...
	void            doImageL1(Object* ref, GfxState* state, GfxImageColorMap* colorMap, GBool invert, GBool inlineImg, Stream* str, int width, int height, int len);
	void            doImageL1Sep(GfxState* state, GfxImageColorMap* colorMap, GBool invert, GBool inlineImg, Stream* str, int width, int height, int len);
	void            doImageL2(Object* ref, GfxState* state, GfxImageColorMap* colorMap, GBool invert, GBool inlineImg, Stream* str, int width, int height, int len, int* maskColors, Stream* maskStr, int maskWidth, int maskHeight, GBool maskInvert);
	...
	void            doImageL3(Object* ref, GfxState* state, GfxImageColorMap* colorMap, GBool invert, GBool inlineImg, Stream* str, int width, int height, int len, int* maskColors, Stream* maskStr, int maskWidth, int maskHeight, GBool maskInvert);
