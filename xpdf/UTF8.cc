...
GBool getUTF8(GString* s, int* i, Unicode* u)
{
	...
	{
		if (*i < s->getLength() - 1 && ((c1 = (Guchar)s->getChar(*i)) & 0xc0) == 0x80 && ((c2 = (Guchar)s->getChar(*i + 1)) & 0xc0) == 0x80)
		{
			*i += 2;
	...
	{
		if (*i < s->getLength() - 2 && ((c1 = (Guchar)s->getChar(*i)) & 0xc0) == 0x80 && ((c2 = (Guchar)s->getChar(*i + 1)) & 0xc0) == 0x80 && ((c3 = (Guchar)s->getChar(*i + 2)) & 0xc0) == 0x80)
		{
			*i += 3;
	...
	{
		if (*i < s->getLength() - 3 && ((c1 = (Guchar)s->getChar(*i)) & 0xc0) == 0x80 && ((c2 = (Guchar)s->getChar(*i + 1)) & 0xc0) == 0x80 && ((c3 = (Guchar)s->getChar(*i + 2)) & 0xc0) == 0x80 && ((c4 = (Guchar)s->getChar(*i + 3)) & 0xc0) == 0x80)
		{
			*i += 4;
	...
	{
		if (*i < s->getLength() - 4 && ((c1 = (Guchar)s->getChar(*i)) & 0xc0) == 0x80 && ((c2 = (Guchar)s->getChar(*i + 1)) & 0xc0) == 0x80 && ((c3 = (Guchar)s->getChar(*i + 2)) & 0xc0) == 0x80 && ((c4 = (Guchar)s->getChar(*i + 3)) & 0xc0) == 0x80 && ((c5 = (Guchar)s->getChar(*i + 4)) & 0xc0) == 0x80)
		{
			*i += 5;
