...
public:
	...
	GBool writeTTF(FoFiOutputFunc outputFunc, void* outputStream, char* name = NULL, int* codeToGID = NULL, Guchar* replacementCmapTable = NULL, int replacementCmapTableLen = 0);
